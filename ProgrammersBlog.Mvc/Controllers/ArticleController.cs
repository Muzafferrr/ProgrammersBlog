...
namespace ProgrammersBlog.Mvc.Controllers
{
    public class ArticleController : Controller
    {
        ...
        public async Task<IActionResult> Detail(int articleId)
        {
            ...
            {
                var userArticles = await _articleService.GetAllByUserIdOnFilter(articleResult.Data.Article.UserId, FilterBy.Category, OrderBy.Date, false, 10, 
                    articleResult.Data.Article.CategoryId, DateTime.Now, DateTime.Now, 0, 99999, 0, 99999); ;
